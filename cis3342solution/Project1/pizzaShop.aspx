...
<body>
    <form id="form2" runat="server">
        ...
        <div id="orderInfo">
            <div id="custInfo">
                <asp:Label ID="lblOutputName" runat="server" Text="Label"></asp:Label>
                <asp:Label ID="lblOutputAddress" runat="server" Text="Label"></asp:Label>
                <asp:Label ID="lblOutputPhone" runat="server" Text="Label"></asp:Label>
            </div><br />
           <div id="order">
